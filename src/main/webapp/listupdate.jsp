...
<table>
	<tr><th>제품번호</th><td><input type="text" name="ID" size="6"/>
		<input type="button" value="중복 검사" onclick="codeCheck()"/></td></tr>
	<tr><th>카테고리</th><td><input type="text" name="CATEGORY" value="<%=c.getCategory() %>" size="5"/></tr>
	<tr><th>제품명</th><td><input type="text" name="P_NAME" size="5"/></td></tr>
	<tr><th>제품설명</th><td><textarea rows="5" cols="DESC" name="DESC"></textarea>
		</td></tr>
	<tr><th>이미지 파일명</th><td><input type="text" name="PITURE" size="10"/>
		</td></tr>
	<tr><th>가 격</th><td><input type="text" name="PRICE" size="10"/></td></tr>
	<tr><th>분 류</th><td><input type="text" name="BUN" size="5"/></td></tr>
